...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            "Only used when --showOrfs is also given. "
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "If specified, show subject ORFs in the individual panel plots. "
    ...
    if args.matcher == "blast":
        ...
        if args.showOrfs:
            if (
                args.databaseFastaFilename is None
                and args.sqliteDatabaseFilename is None
            ):
                print(
                    "Either --databaseFastaFilename or "
                ...
                args.databaseFastaFilename is None
                or args.sqliteDatabaseFilename is None
            ):
                print(
                    "--databaseFastaFilename and --sqliteDatabaseFilename "
            ...
            if (
                args.databaseFastaFilename
                or args.sqliteDatabaseFilename
                or args.databaseFastaDirectory
            ):
                print(
                    "The --databaseFastaFilename, --sqliteDatabaseFilename, "
        ...
        readsAlignments = DiamondReadsAlignments(
            reads,
            jsonFiles,
            sortFilenames=args.sortFilenames,
            databaseFilename=args.databaseFastaFilename,
            databaseDirectory=args.databaseFastaDirectory,
            sqliteDatabaseFilename=args.sqliteDatabaseFilename,
        )
