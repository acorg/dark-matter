...
class DistanceMatrix:
    ...
    def __init__(self):
        ...
        # queries from a SAM file. The values are 1 or 0 when queries match
        # / do not match references unless we are using alignment scores,
        # as generated by tools like bowtie2 and bwa and stored in a SAM
        # tag. In that case, the alignment score value is stored (see
    ...
    def score(self, referenceId, queryId):
        ...
        """
        try:
            return self._scores[referenceId][queryId]
        except KeyError:
            return 0.0
    ...
    def jaccardDistance(self, referenceId1, referenceId2):
        ...
        """
        queryIds1 = set(self._scores.get(referenceId1, []))
        queryIds2 = set(self._scores.get(referenceId2, []))
